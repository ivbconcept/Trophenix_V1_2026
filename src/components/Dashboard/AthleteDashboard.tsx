  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-[1200px] mx-auto px-8 py-6 relative">
        <div className="fixed top-0 left-[calc(50%+120px)] -translate-x-1/2 z-50 flex items-center justify-between bg-white rounded-2xl p-4 shadow-sm w-[calc(1200px-4rem)]">
