  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 py-6 relative">
        <div className="fixed top-4 left-1/2 -translate-x-1/2 z-50 flex items-center justify-between bg-white rounded-2xl p-3 md:p-4 shadow-sm transition-all duration-300 w-[calc(100%-2rem)] sm:w-[calc(100%-3rem)] md:w-[calc(100%-4rem)] lg:w-[calc(100%-6rem)] xl:w-[1136px]">
