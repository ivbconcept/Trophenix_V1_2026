            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-1">Actualités du Sport</h3>
                    <p className="text-sm text-slate-500">Les dernières nouvelles</p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-medium text-slate-900 mb-1 line-clamp-2">Paris 2024: Les préparatifs s'intensifient</h4>
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-16 h-16 bg-slate-200 rounded-lg flex-shrink-0"></div>
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-medium text-slate-900 mb-1 line-clamp-2">Nouveaux records lors du championnat</h4>
                      <p className="text-xs text-slate-500">Il y a 5 heures</p>
                    </div>
                  </div>
                </div>
                <button className="mt-4 w-full text-sm font-medium text-blue-600 hover:text-blue-700 flex items-center justify-center gap-1">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="text-lg font-semibold text-slate-900 mb-1">Opportunités</h3>
                    <p className="text-sm text-slate-500">Nouvelles offres pour vous</p>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-medium text-slate-900 mb-1">Ambassadeur de marque</h4>
                      <p className="text-xs text-slate-500">Nike • Paris</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <h4 className="text-sm font-medium text-slate-900 mb-1">Partenariat sponsoring</h4>
                      <p className="text-xs text-slate-500">Adidas • Lyon</p>
                    </div>
                  </div>
                </div>
                <button className="mt-4 w-full text-sm font-medium text-green-600 hover:text-green-700 flex items-center justify-center gap-1">
