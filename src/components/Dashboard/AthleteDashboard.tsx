...
import { Briefcase, FileText, MessagesSquare, Star, TrendingUp, Award, Heart, ChevronRight, MoreVertical, Play, Newspaper, Mail, Bell, Search } from 'lucide-react';
            ...
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-2 ml-6">
                <button className="relative p-2.5 hover:bg-white/80 rounded-xl transition-all hover:shadow-sm group">
                  <MessagesSquare className="w-6 h-6 text-slate-600 group-hover:text-slate-900 transition-colors" strokeWidth={1.5} />
