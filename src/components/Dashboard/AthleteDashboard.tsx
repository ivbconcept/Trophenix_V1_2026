...
export function AthleteDashboard({ onNavigate }: AthleteDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="fixed top-0 left-0 right-0 z-50 bg-slate-50 py-4">
        <div className="max-w-[1200px] mx-auto px-4 md:px-8">
          <div className="flex items-center justify-between bg-white rounded-2xl p-3 md:p-4 shadow-sm">
      ...
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 pt-24 pb-6">
