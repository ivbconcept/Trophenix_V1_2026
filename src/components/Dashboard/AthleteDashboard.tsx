...
export function AthleteDashboard({ onNavigate }: AthleteDashboardProps) {
  ...
  return (
    <div className="min-h-screen bg-slate-50">
      <div className="max-w-[1200px] mx-auto px-4 md:px-8 pt-0 pb-6">
        <div className="sticky top-0 z-50 flex items-center justify-between bg-white rounded-2xl p-3 md:p-4 shadow-sm mb-8">
