              ...
              <div className="flex animate-scroll">
                <div className="flex space-x-16 items-center">
                  <div className="flex items-center justify-center h-20 w-48 grayscale hover:grayscale-0 transition-all">
                    <svg viewBox="0 0 272 92" className="h-12 w-auto">
                  ...
                  <div className="flex items-center justify-center h-20 w-48 grayscale hover:grayscale-0 transition-all">
                    <div className="text-center">
                      <div className="font-bold text-3xl text-blue-600">France</div>
                      <div className="font-bold text-2xl text-slate-700">Travail</div>
                    </div>
                  </div>
                  <div className="flex items-center justify-center h-20 w-48 grayscale hover:grayscale-0 transition-all">
                    <div className="font-bold text-4xl text-slate-800">Wexecutive</div>
                  </div>
                  <div className="flex items-center justify-center h-20 w-48 grayscale hover:grayscale-0 transition-all">
                    <svg viewBox="0 0 272 92" className="h-12 w-auto">
                      <path fill="#FF6600" d="M138.5 46c0-25.4-20.6-46-46-46s-46 20.6-46 46 20.6 46 46 46 46-20.6 46-46zm-46 30c-16.5 0-30-13.5-30-30s13.5-30 30-30 30 13.5 30 30-13.5 30-30 30z"/>
                      <path fill="#000000" d="M172 26h8v12h-8zm0 16h8v26h-8zm16-16h8v42h-8zm16 0h8v12h-8zm0 16h8v26h-8zm16-16h8v12h-8zm0 16h8v26h-8zm16 10c0-5.5 4.5-10 10-10v8c-1.1 0-2 .9-2 2v18h-8V52z"/>
                    </svg>
                  </div>
                </div>
