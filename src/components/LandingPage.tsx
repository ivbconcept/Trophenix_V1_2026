          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-2xl mx-auto">
                Une plateforme complète dédiée à la réussite des sportifs et des entreprises
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4">Excellence garantie</h3>
                <p className="text-slate-600 leading-relaxed">
                  Notre plateforme sélectionne rigoureusement chaque profil pour garantir la qualité et la pertinence des opportunités proposées.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4">Réseau exclusif</h3>
                <p className="text-slate-600 leading-relaxed">
                  Accédez à un réseau d'entreprises partenaires et de sportifs de haut niveau, tous engagés dans la réussite mutuelle.
                </p>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-slate-200 hover:shadow-xl transition-all">
                ...
                <p className="text-slate-600 leading-relaxed">
                  Bénéficiez d'un suivi individualisé et de conseils d'experts pour maximiser vos chances de réussite professionnelle.
                </p>
              </div>
            </div>
          </div>
