      ...
      <div className="sticky top-0 bg-slate-50 dark:bg-black z-40">
        <div className="px-6 py-6">
          ...
          <div className="flex items-center justify-between gap-4">
            ...
            <button className="inline-flex items-center gap-2 px-6 py-2 rounded-xl border border-slate-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 text-slate-900 dark:text-white font-semibold text-base hover:bg-slate-50 dark:hover:bg-zinc-800 transition-all shadow-sm">
