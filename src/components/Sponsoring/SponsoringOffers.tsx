      ...
      const mockOffers: SponsoringOffer[] = [
        {
          ...
          company_logo: '/dist/assets/logo_nike-removebg-preview-DO1ardwx.png',
          ...
          status: 'active',
          image_url: '/dist/assets/cycling-road-unsplash-B81rp4HD.jpg',
        ...
        },
        {
          ...
          company_logo: '/dist/assets/1196px-Accor_Logo-Bf9l4iNM.png',
          ...
          status: 'active',
          image_url: '/dist/assets/stadium-rugby-unsplash-Dh-4ze46.jpg',
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString()
        },
        {
          ...
          company_logo: '/dist/assets/venti-views-cHRDevKFDBw-unsplash-CYBgv0z9.jpg',
          ...
          status: 'active',
          image_url: '/dist/assets/venti-views-cHRDevKFDBw-unsplash-CYBgv0z9.jpg',
          created_at: new Date().toISOString(),
          updated_at: new Date().toISOString()
        },
        {
        ...
        },
        {
          ...
          company_logo: '/dist/assets/cycling-road-unsplash-B81rp4HD.jpg',
          company_sector: 'Équipementier Sportif',
