...
export const FOOTBALL_CLUBS = [
  ...
  'Paris FC', 'Grenoble Foot 38', 'Amiens SC', 'US Orléans', 'Red Star FC',
  'AS Saint-Étienne', 'Pau FC', 'Rodez AF', 'FC Annecy', 'USL Dunkerque',
  'Estac Troyes', 'Valenciennes FC', 'Dijon FCO',

  // Clubs historiques National et régionaux
  'FC Sochaux-Montbéliard', 'AS Nancy-Lorraine', 'FC Metz', 'AS Cannes',
  'Nîmes Olympique', 'Clermont Foot', 'Chamois Niortais', 'Tours FC',
  'Châteauroux', 'Quevilly-Rouen', 'US Créteil', 'US Avranches',
];
...
export const BASKETBALL_CLUBS = [
  ...
  'Gravelines Dunkerque', 'Élan Béarnais Pau-Lacq-Orthez', 'Boulogne-Levallois',
  'SIG Strasbourg', 'Orléans Loiret Basket', 'BCM Gravelines-Dunkerque',
  'Nanterre 92', 'Roanne', 'Chalon-sur-Saône',
...
export const RUGBY_CLUBS = [
  // Top 14
  'Stade Toulousain', 'UBB Bordeaux-Bègles', 'Stade Rochelais', 'ASM Clermont Auvergne',
  'Racing 92', 'Stade Français Paris', 'Castres Olympique', 'Lyon OU',
  ...
  'Béziers', 'Narbonne', 'Mont-de-Marsan', 'Rouen Normandie Rugby',
  'Vannes RC', 'Massy', 'Nice Côte d\'Azur',
];
...
export const HANDBALL_CLUBS = [
  ...
  'Fenix Toulouse Handball', 'USAM Nîmes Gard', 'Chambéry Savoie Mont Blanc Handball',
  'Saint-Raphaël Var Handball', 'Dunkerque HB Grand Littoral', 'Limoges Handball',
  'US Ivry Handball', 'PAUC Handball', 'Cesson Rennes Métropole Handball',
  'Chartres Métropole 28', 'US Créteil Handball',

  // ProLigue et clubs amateurs
  'Istres Provence Handball', 'Tremblay-en-France Handball', 'Dijon Handball',
  'Billère Handball Pyrénées', 'Pontault-Combault Handball', 'Sélestat Alsace Handball',
];
...
export const VOLLEYBALL_CLUBS = [
  ...
  'Tourcoing Lille Métropole', 'Montpellier UC', 'Arago de Sète',
  ...
  'Béziers Volley', 'Vandœuvre Nancy Volley-Ball', 'Nantes Rezé Métropole Volley',
  'Mougins Volley-Ball', 'Saint-Raphaël Var Volley-Ball',
];

// 🎾 TENNIS
export const TENNIS_CLUBS = [
  'Tennis Club de Paris', 'Racing Club de France', 'Stade Français',
...
export const SWIMMING_CLUBS = [
  ...
  'CN Calédoniens', 'Stade de Reims Natation', 'Montpellier Métropole Natation',
  'Amiens Métropole Natation', 'Olympique la Garenne-Colombes',
  'Cercle Nageurs Melun Val de Seine', 'Nautic Club Nîmes',
];

// 🏃 ATHLÉTISME
export const ATHLETICS_CLUBS = [
  'US Créteil Athlétisme', 'Athlétic Club de Boulogne-Billancourt',
  'Entente Franconville Cesame Val-d\'Oise', 'Stade Français',
  'Union Sportive Métropolitaine des Transports', 'CA Montreuil 93',
  'Toulouse UC', 'AC Décines', 'Élan 91', 'AS Saint-Médard-en-Jalles',
  'EA Douchy', 'AS La Pomme Marseille', 'Montpellier Athlétisme',
];

// 🚴 CYCLISME
export const CYCLING_CLUBS = [
  'AG2R Citroën Team', 'Groupama-FDJ', 'Cofidis', 'Arkéa-Samsic',
  'TotalEnergies', 'B&B Hotels-KTM', 'Decathlon AG2R La Mondiale',
  'US Créteil Cyclisme', 'VC Rouen 76', 'Vélo Club La Pomme Marseille',
  'UV Aube', 'EC Saint-Étienne', 'Vélo Sprint Narbonnais',
];

// 🥋 JUDO
export const JUDO_CLUBS = [
  'Paris Saint-Germain Judo', 'Levallois Sporting Club Judo',
  'Racing Club de France Judo', 'US Orléans Judo', 'Red Star Club Champigny',
  'AS Monaco Judo', 'Entente Sportive Blanc-Mesnil', 'JC Villebon',
  'Stade de Vanves', 'Amiens Judo Club', 'Étoile Sportive du Blanc-Mesnil',
];

// 🥊 BOXE
export const BOXING_CLUBS = [
  'Paris Université Club Boxing', 'CSA des Armées', 'Boxing Beats',
...
export const WINTER_SPORTS_CLUBS = [
  ...
  'SC La Clusaz', 'SC Megève', 'US Combloux', 'SC Les Rousses',
  'SC Xonrupt', 'SC Val d\'Abondance', 'SC Grand-Bornand',
  'Font-Romeu Club Nordique', 'Grenoble Université Club Ski',
];

// 🚣 AVIRON
export const ROWING_CLUBS = [
  'Aviron Bayonnais', 'Cercle de l\'Aviron de Nancy', 'CN Marseille Aviron',
  'Société Nautique de Bayonne', 'Union Nautique de Lyon', 'Rowing Club Strasbourg',
...
export const SAILING_CLUBS = [
  'Yacht Club de France', 'Société Nautique de Marseille', 'ENVSN Brest',
  'Yacht Club de Monaco', 'Cercle Nautique de Nice', 'Cercle de la Voile de Paris',
  'Yacht Club de Toulon', 'Société des Régates Rochelaises', 'Union Nautique de Bordeaux',
  'Cercle Nautique Calédonien', 'Société Nautique de la Baie de Saint-Malo',
];

// 🤺 ESCRIME
export const FENCING_CLUBS = [
  'Paris Université Club Escrime', 'Racing Club de France Escrime',
  'CS Bois-Colombes', 'US Métro Transport', 'Stade Français Escrime',
  'AS Monaco Escrime', 'Lagardère Paris Racing', 'Lyon Escrime',
  'Cercle d\'Escrime Melun Val de Seine', 'Bourg-la-Reine Escrime',
];

// 🏇 ÉQUITATION
export const EQUESTRIAN_CLUBS = [
  'Haras de Jardy', 'Pôle International du Cheval', 'Écurie du Lys',
  'Écuries du Grand Parquet', 'Centre Équestre de Fontainebleau',
  'Haras de Hus', 'Cavaliers du Bois', 'Poney Club du Touquet',
  'Écuries de la Cense', 'Centre Équestre de Lamotte-Beuvron',
];

// 🏒 HOCKEY SUR GLACE
export const ICE_HOCKEY_CLUBS = [
  'Brûleurs de Loups de Grenoble', 'Dragons de Rouen', 'Boxers de Bordeaux',
 ...
 * @param sportFilter - Optionnel: Filtrer par sport de l'athlète
 * @returns Liste des clubs triés par pertinence
 */
export function searchClubs(query: string, sportFilter?: string): string[] {
  if (!query || query.length < 2) {
    // Si pas de requête, afficher les clubs les plus populaires
  ...
  if (sportFilter) {
    ...
    } else if (sportLower.includes('athlé')) {
      priorityClubs = ATHLETICS_CLUBS;
    } else if (sportLower.includes('cyclisme') || sportLower.includes('vélo')) {
    ...
    } else if (sportLower.includes('équitation') || sportLower.includes('cheval')) {
  ...
  const results = ALL_CLUBS.map(club => {
    ...
    // Bonus si le club est dans la catégorie du sport
